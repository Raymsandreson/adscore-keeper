 ...
 * O cronômetro não emite som em nenhum desses avisos — toast, notificação do
 * sistema e dialog dão o recado. Som só no chamado da gestão.
 */
...
/**
 * Alarme sonoro alto e incômodo (bipes alternados). Reservado ao CHAMADO DA
 * GESTÃO. Os avisos do próprio cronômetro (ociosidade, pausa estourada,
 * previsão estourada, "ainda está fazendo?") são silenciosos por decisão do
 * usuário — avisam por toast/notificação/dialog, nunca por som.
 */
        ...
        if (gapWorking) {
          ...
          if (next.idleSeconds - lastGapNudgeRef.current >= 300) {
            ...
            if (interacting) {
              ...
              // Ocioso de verdade: cobra a cada 5 min, sem som.
              setAwayPrompt(true);
