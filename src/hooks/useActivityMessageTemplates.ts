...
export const TEMPLATE_VARIABLES = [
  ...
  { var: '{{tempo_dedicado}}', label: 'Tempo dedicado à atividade (soma do cronômetro)' },
  { var: '{{etapa}}', label: 'Fase do fluxo (stage do kanban)' },
  { var: '{{objetivo}}', label: 'Objetivo do fluxo (checklist)' },
  { var: '{{passo_atual}}', label: 'Passo atual do fluxo' },
