...
/**
 * Card compacto de ranking — mesmo tamanho dos KPIs da barra do FocusDashboard.
 * Mostra posição do usuário no time. Clique abre popover com top 5.
 */
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-64 p-2" align="start">
        <div className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide px-1 pb-1.5 flex items-center gap-1">
          <Trophy className="h-3 w-3" /> Top do time · hoje
        </div>
