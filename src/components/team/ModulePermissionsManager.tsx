...
export function ModulePermissionsManager() {
  ...
  return (
    <Card className="border-0 shadow-card">
      ...
      <CardContent>
        <div 
          className="overflow-x-auto [direction:rtl] [transform:rotateX(180deg)]"
        >
          <div className="[direction:ltr] [transform:rotateX(180deg)]">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="min-w-[200px] sticky left-0 z-10 bg-card">Membro</TableHead>
