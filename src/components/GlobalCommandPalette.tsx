...
export function GlobalCommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    // Seções do Dashboard
    {
      ...
      action: () => navigate("/dashboard?tab=paid"),
    ...
    },
    {
      ...
      action: () => navigate("/dashboard?tab=organic"),
    ...
    },
    {
      ...
      action: () => navigate("/dashboard?tab=automation"),
    ...
    // Automação - Subseções
    {
      ...
      action: () => navigate("/dashboard?tab=automation&subtab=comments"),
    ...
    },
    {
      ...
      action: () => navigate("/dashboard?tab=automation&subtab=funnel"),
    ...
    },
    {
      ...
      icon: <Bot className="h-4 w-4" />,
      action: () => navigate("/dashboard?tab=automation&subtab=automation"),
    ...
    },
    {
      ...
      icon: <Trophy className="h-4 w-4" />,
      action: () => navigate("/dashboard?tab=automation&subtab=championship"),
