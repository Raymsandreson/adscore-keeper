...
interface ContentMetric {
  ...
  avgWatchTime?: number; // em segundos
  completionRate?: number; // para vídeos
...
const COLORS = ['#E1306C', '#405DE6', '#833AB4', '#FF0000', '#1877F2', '#C13584', '#FD1D1D'];
...
export const ContentTypeMetrics = ({ period, onPeriodChange }: ContentTypeMetricsProps) => {
  ...
  const radarData = [
    { metric: 'Curtidas', instagram: 0, facebook: 0, youtube: 0, tiktok: 0 },
    { metric: 'Comentários', instagram: 0, facebook: 0, youtube: 0, tiktok: 0 },
    { metric: 'Compartilhamentos', instagram: 0, facebook: 0, youtube: 0, tiktok: 0 },
    { metric: 'Salvos', instagram: 0, facebook: 0, youtube: 0, tiktok: 0 },
    { metric: 'Alcance', instagram: 0, facebook: 0, youtube: 0, tiktok: 0 },
  ];
