...
export const featureGuides: FeatureGuideDef[] = [
  ...
  },
  {
    ...
    paths: ["/relatorios"],
    title: "Relatórios IA",
    intro: "Converse com o analista: ele consulta o banco, mostra a tabela e aponta o que está estranho no dado (somente leitura; CPF mascarado).",
    items: [
      { label: "Exemplos clicáveis", anchor: "Casos abertos por núcleo", description: "ex.: 'Casos abertos por núcleo', 'Quais dados do funil BPC estão furados?'" },
      { label: "Campo de pergunta", description: "Enter envia; a IA pode rodar até 3 consultas pra cruzar o que a primeira levantou" },
      { label: "Conversas", anchor: "Nova conversa", description: "ficam gravadas: F5 não apaga, dá pra ter várias, renomear e apagar" },
      { label: "Ver a consulta usada", description: "mostra o SQL que gerou cada tabela" },
    ],
    tip: "Pergunte do jeito que você falaria (\"atividades atrasadas do João\") e siga com follow-up (\"e desses, quantos fecharam?\") em vez de reescrever a pergunta.",
  },
  {
    id: "team",
    paths: ["/team"],
