// Deploy do analyze-news-case → Supabase EXTERNO (kmedldlepwiityjsdahz).
// Uso:  SUPABASE_PAT=seu_token node _deploy_analyze_news_case.mjs
...
const SLUG = 'analyze-news-case';
const PAT = process.env.SUPABASE_PAT;
if (!PAT) { console.error('Faltou SUPABASE_PAT. Ex: SUPABASE_PAT=sbp_... node _deploy_analyze_news_case.mjs'); process.exit(1); }

const code = readFileSync('supabase/functions/analyze-news-case/index.ts', 'utf8');
