// Deploy do enrich-news-leads → Supabase EXTERNO (kmedldlepwiityjsdahz).
// Uso:  SUPABASE_PAT=seu_token node _deploy_enrich_news_leads.mjs
...
const SLUG = 'enrich-news-leads';
const PAT = process.env.SUPABASE_PAT;
if (!PAT) { console.error('Faltou SUPABASE_PAT. Ex: SUPABASE_PAT=sbp_... node _deploy_enrich_news_leads.mjs'); process.exit(1); }

const code = readFileSync('supabase/functions/enrich-news-leads/index.ts', 'utf8');
