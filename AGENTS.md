# Instruções Permanentes — Codex (adscore-keeper)
...
3. **Mostre ponto de inserção antes em arquivos sensíveis**: em AGENTS.md, proximos_passos.md, migrations SQL, config de produção, sempre mostrar onde vai inserir antes de aplicar. Usuário aprova o "onde" separado do "o quê".
