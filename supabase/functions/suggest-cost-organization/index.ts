          ...
          function: {
            ...
            parameters: {
              ...
              properties: {
                ...
                tax_optimization_tips: { type: "string", description: "Planejamento tributário detalhado como advogado tributarista, incluindo regime tributário ideal, créditos fiscais, e estratégias de elisão fiscal" },
                asset_preservation_strategy: { type: "string", description: "Estratégia de preservação patrimonial com holdings (patrimonial, operacional, administrativa), planejamento sucessório e blindagem patrimonial" },
              },
