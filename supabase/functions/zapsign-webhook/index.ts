...
import { remapToExternal, remapToCloud } from "../_shared/uuid-remap.ts";
      ...
      try {
        ...
        if (leadForBoard?.board_id) {
          ...
          const { data: boardSettings } = await supabase
            ...
            .select('auto_close_lead_on_sign, auto_create_group_on_sign, auto_archive_on_sign, post_sign_mode, initial_message_template, use_ai_message, ai_generated_message, send_audio_message, audio_voice_id, lead_fields, process_workflows, process_workflow_board_id, processual_acolhedor_id')
