-- Resposta no chat vira o ÚLTIMO desempate do telão /tv/atividades.
--
-- Ordem nova: passos, concluídas, menos atrasadas, mais tempo ativo,
-- menos ocioso e, por fim, resposta no chat interno. Nada mais muda
-- (CTEs, filtros e JSON idênticos a 20260721170000).
--
-- Assinatura inalterada (timestamptz, uuid, text) → create or replace.
-- Rollback: re-rodar 20260721170000_tv_ranking_tempo_ativo.sql.
