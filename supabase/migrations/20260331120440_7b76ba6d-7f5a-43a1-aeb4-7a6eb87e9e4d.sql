-- Fix the security definer view issue that may cause "database error querying schema"
DROP VIEW IF EXISTS public.whatsapp_ai_agents;

CREATE VIEW public.whatsapp_ai_agents
