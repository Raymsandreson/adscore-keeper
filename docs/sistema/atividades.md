...
- **Atalho pra atividade**: o passo mostra em qual atividade foi marcado; objetivo e fase mostram a atividade do **último passo**, que fechou o conjunto. Clica e abre a ficha. Isso exigiu passar a **gravar** o vínculo: `log_checklist_step` ganhou `p_activity_id` (sobrecarga de 5 args, sem default — default criaria ambiguidade com a de 4, que segue existindo e delega), preenchido pelo `LeadFunnelProgressBar` quando ele roda dentro da ficha da atividade. Passo marcado na ficha do processo fica sem atividade, e **passos anteriores a 04/08/2026 também** — o log não guardava o vínculo e não dá pra reconstruir (título nunca bate: 0 de 865; correlação por horário casava só ~67%).
- Migrations: `20260804180000`, `20260804193000`, `20260804203000`.
